...
american_football = Activity.find_by(name: "American football")
baseball = Activity.find_by(name: "Baseball")
basket = Activity.find_by(name: "Basketball")
football = Activity.find_by(name: "Football")
horse_riding = Activity.find_by(name: "Horse riding")
ice_hokey = Activity.find_by(name: "Ice hokey")
ice_skating = Activity.find_by(name: "Ice skating")
kayaking = Activity.find_by(name: "Kayaking")
pingpong = Activity.find_by(name: "Ping pong")
skiing = Activity.find_by(name: "Skiing")
snowboarding = Activity.find_by(name: "Snow boarding")
volley = Activity.find_by(name: "Volleyball")
...
p Record.create(user: mathieu, activity: horse_riding, duration: 120, date: "2013-05-12")
p Record.create(user: mathieu, activity: skiing, duration: 180, date: "2010-01-31")
